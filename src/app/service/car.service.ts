...
import sampleData  from 'src/app/common/car-small.json';
// import {  } from '@angular/http';
//import { Observable } from "rxjs/Observable";
// import 'rxjs/add/operator/map';
import { Observable } from 'rxjs';
import { map } from "rxjs/operators";
import { Groupcar } from '../domain/groupcars';
...
//   getCarsSmall() {
//     return this.http.get('assets/showcase/resources/data/cars-small.json')
//                 .toPromise()
//                 .then(res => <Car[]> res)
...
// }
  ...
  getCarsSmall() : Car[]  {
    // return this.http.get('app/common/car-small.json')
    //             .pipe(
    //               map((res => res)));
